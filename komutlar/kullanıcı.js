...
//if(message.channel.id != "765661651130908732") return message.channel.send("Bu Komutu Sadece <#765661651130908732> ta Kullanabilirsin");
  ...
  //Fe0rlex tarafından geliştirilmiştir
        ...
        .setDescription(`
\n**• \`${ayarlar.prefix}kullanıcı-bilgi\`=**Kullanıcı Bilgisini Görürsünüz.
\n**• \`${ayarlar.prefix}sunucu-bilgi\`=**Sunucu Hakkında Bilgi Alırsınız.
\n**• \`${ayarlar.prefix}rol-bilgi\`=**Roller,hakkında Bilgi Alırsınız.**`)

    //.addField("» Linkler", `[Web Sitesi Yapımda](http://7354124.305283.renderforestsites.com/)  `, false)  
       .setThumbnail(message.author.avatarURL)
        .setFooter(`${message.author.username} Tarafından İstendi.`, message.author.avatarURL)
.setImage('https://media.discordapp.net/attachments/777181570016083988/777182863916531712/standard.giff')
